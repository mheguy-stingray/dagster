...
class MultiAssetSensorEvaluationContext(SensorEvaluationContext):
    ...
    def __init__(
        ...
        if isinstance(monitored_assets, AssetSelection):
            repo_assets = self._repository_def._assets_defs_by_key.values()  # noqa: SLF001
        ...
        for asset_key in self._monitored_asset_keys:
            assets_def = self._repository_def._assets_defs_by_key.get(asset_key)  # noqa: SLF001
    ...
    def _get_asset(self, asset_key: AssetKey, fn_name: str) -> AssetsDefinition:
        ...
        repository_assets = repo_def._assets_defs_by_key  # noqa: SLF001
            ...
            asset_keys = cast(
                ...
                list(
                    monitored_assets.resolve(
                        list(set(repository_def._assets_defs_by_key.values()))  # noqa: SLF001
                    )
                ),
            )
        else:
