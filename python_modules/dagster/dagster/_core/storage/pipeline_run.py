        ...
        if "selector" in unpacked:
            ...
            check.invariant(
                ...
                (
                    ...
                    f"selector was passed with pipeline {selector.name}"
                ),
            )
            if pipeline_name is None:
                unpacked["pipeline_name"] = selector.name
            ...
            check.invariant(
                ...
                (
                    ...
                    f" PipelineRun: selector was passed with subset {selector.solid_subset}"
                ),
            )
